        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <form action="{{ route('companies.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <select name="industry" id="industry"
                        ...
                        @foreach ($industries as $industry)
                            <option value="{{ $industry }}" @selected(old('industry') == $industry)>
                                {{ $industry }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4" x-data="{ show: false }">
                    ...
                    <div class="relative">
                        <input id="owner_password" name="owner_password" value="{{ old('owner_password') }}"
                        ...
                        <button type="button" class="absolute inset-y-0 right-2 flex items-center text-gray-500"
                            ...
                            <svg x-show="show" xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M13.875 18.825a9.56 9.56 0 01-1.875.175c-4.478
